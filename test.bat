...
adb -s %1 shell am instrument -w -r -e debug false -e class 'com.kidscademy.atlas.tablet.ReaderTest' com.kidscademy.atlas.instruments.test/android.support.test.runner.AndroidJUnitRunner
...
adb -s %1 shell am instrument -w -r -e debug false -e class 'com.kidscademy.atlas.tablet.ReaderSyncTest' com.kidscademy.atlas.instruments.test/android.support.test.runner.AndroidJUnitRunner
