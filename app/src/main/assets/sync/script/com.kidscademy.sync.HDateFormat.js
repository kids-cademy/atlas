...
com.kidscademy.sync.HDateFormat = function() {
};

com.kidscademy.sync.HDateFormat.Format = [ "DATE", "YEAR", "DECADE", "CENTURY", "MILLENNIA", "KYA", "MYA", "BYA" ];

com.kidscademy.sync.HDateFormat.Period = [ "FULL", "BEGINNING", "MIDDLE", "END" ];

com.kidscademy.sync.HDateFormat.Era = [ "CE", "BCE" ];

com.kidscademy.sync.HDateFormat.RomanSymbols = {
	M : 1000,
	CM : 900,
	D : 500,
	CD : 400,
...
com.kidscademy.sync.HDateFormat.prototype = {
	...
	roman : function(number) {
		var symbols = com.kidscademy.sync.HDateFormat.RomanSymbols;
		var value = '';
	...
	getFormat : function(hdate) {
		...
		return com.kidscademy.sync.HDateFormat.Format[hdate.mask & 0x000000FF];
	},
	...
	getEra : function(hdate) {
		...
		return com.kidscademy.sync.HDateFormat.Era[(hdate.mask & 0x00FF0000) >> 16];
	},
	...
	toString : function() {
		return "com.kidscademy.sync.HDateFormat";
	}
};
$extends(com.kidscademy.sync.HDateFormat, Object);
